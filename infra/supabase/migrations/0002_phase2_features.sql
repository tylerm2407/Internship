-- InternshipMatch Phase 2 Schema
...
-- Finance-native pipeline: researching → networking → applied → hirevue →
...
-- ============================================================
-- ALUMNI (public read, service role write)
-- Privacy-safe: NO email addresses or LinkedIn URLs stored.
-- Only name, firm, role, grad year, and connection hooks.
-- ============================================================
...
-- ============================================================
-- NETWORKING CONTACTS (user-owned CRM)
-- Tracks outreach, follow-ups, call notes, referral chains.
-- ============================================================
...
-- ============================================================
-- PREP SESSIONS (user-owned)
-- Cross-session memory for interview prep with readiness scoring.
-- ============================================================
...
-- ============================================================
-- PREP ANSWERS (user-owned, per-question tracking)
-- Enables spaced repetition and weakness detection.
-- ============================================================
...
-- ============================================================
-- READINESS SCORES (user-owned, aggregated mastery per topic)
-- Updated after each prep session for spaced repetition.
-- ============================================================
...
-- ============================================================
-- TIMELINE EVENTS (user-owned, personalized calendar items)
-- ============================================================
