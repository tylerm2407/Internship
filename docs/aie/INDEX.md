...
| # | Slug | Title | Date | Severity | Domain | Status |
|---|------|-------|------|----------|--------|--------|
| AIE-001 | supabase-initial-schema | Supabase: 5 tables with RLS (users, profiles, firms, postings, fit_scores) | 2026-04-08 | critical | database | complete |
| AIE-002 | pydantic-data-models | Pydantic v2 data models: 7 Phase 1 models with full typing | 2026-04-08 | major | backend | complete |
